...
<html>
	...
	<body>
		<a href="#show-stockHistory" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-stockHistory" class="content scaffold-show" role="main">
			...
			<ol class="property-list stockHistory">
			
				<g:if test="${stockHistoryInstance?.user}">
				<li class="fieldcontain">
					<span id="user-label" class="property-label"><g:message code="stockHistory.user.label" default="User" /></span>
					
						<span class="property-value" aria-labelledby="user-label"><g:fieldValue bean="${stockHistoryInstance}" field="user"/></span>
				...
				<g:if test="${stockHistoryInstance?.situacao}">
				<li class="fieldcontain">
					<span id="situacao-label" class="property-label"><g:message code="stockHistory.situacao.label" default="Situacao" /></span>
					
						<span class="property-value" aria-labelledby="situacao-label"><g:fieldValue bean="${stockHistoryInstance}" field="situacao"/></span>
			...
			<g:form url="[resource:stockHistoryInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${stockHistoryInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
